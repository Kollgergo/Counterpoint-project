...
QT_MOC_LITERAL(1, 9, 14), // "playBackEnding"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "PlayBack\0playBackEnding\0"
};
...
void PlayBack::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PlayBack *_t = static_cast<PlayBack *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (PlayBack::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PlayBack::playBackEnding)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject PlayBack::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_PlayBack.data,
